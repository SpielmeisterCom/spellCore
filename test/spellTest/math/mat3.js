		...
		"use strict"
			...
			describe("spell.math.mat3", function() {
				...
				it("should create an matrix from another matrix correctly", function() {
						var matrix = mat3.clone([1,2,3,4,5,6,7,8,9])
						if(
							matrix[0] !== 1 ||
							matrix[1] !== 2 ||
							matrix[2] !== 3 ||
	            ...
	            it("should implement the str function correctly", function() {
						var matrix      = mat3.clone( [1,2,3,4,5,6,7,8,9] ),
							...
							correctStr  = 'mat3(1, 2, 3, 4, 5, 6, 7, 8, 9)'
...
//						var matrixA = mat3.clone( [1,2,3,4,5,6,7,8,9] ),
//							matrixB = mat3.clone( [1,2,3,4,5,6,7,8,9] )
//
...
//						var matrixA = mat3.clone([1,2,3,4,5,6,7,8,9]),
//							matrixB = mat3.clone([9,8,7,6,5,4,3,2,1])
//
...
//					var matrix = mat3.create(),
//						matrixB = mat3.create(),
//						testMatrix = mat3.clone([1,2,3,4,5,6,7,8,9]),
//						vector = vec2.clone([2.5, -4.5]),
...
//					var matrixA = mat3.clone( [12.2, 3, 6, 1, -4, 7, 2, 5, 8] ),
//						matrixB = mat3.clone( [-8, 3, 6, 1, 4, 7, 2, 5, 2.4]),
//						expectedResultA = mat3.clone( [ -82.6, -6, 21, 30.2, 22, 90, 34.2, -2, 66.2 ]),
//						expectedResultB = mat3.clone( [ -82.6, 78.6, 108.6, 2, 22, -5.2, 5, 66, 66.2 ]),
//						result  = mat3.create()
//
//
//					//Multiply A*B
